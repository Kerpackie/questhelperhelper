namespace QHH.Services
{
    ...
    public class HandlerService : InitializedService
    {
        ...
        public HandlerService(IServiceProvider provider, IConfiguration configuration, DiscordSocketClient client,
    ...
    [System.Diagnostics.CodeAnalysis.SuppressMessage("StyleCop.CSharp.MaintainabilityRules",
        "SA1402:File may only contain a single type", Justification = "Directly related to the handler service.")]
    public abstract class DiscordHandler
    {
        ...
        public virtual Task InitializeAsync(DiscordSocketClient client, IServiceProvider serviceProvider,
        ...
        /// <param name="serviceProvider">The <see cref="IServiceProvider"/> to inject.</param>
        /// <param name="configuration">The <see cref="IConfiguration"/> to inject.</param>
        public virtual void Initialize(DiscordSocketClient client, IServiceProvider serviceProvider,
            IConfiguration configuration)
        {
        }
    }
